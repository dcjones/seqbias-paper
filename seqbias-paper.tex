...
\begin{figure*}
\centerline{\includegraphics[width=0.8\textwidth]{freqs.eps}}
...
from unadjusted reads counts as well as after adjusting read counts using each
method.}
\label{fig:kl}
\end{figure*}
...
\begin{figure}
\centerline{\includegraphics[width=0.3\textwidth]{pois-boxplot.eps}}
...
the span between the 25\% and 75\% quantiles).
}
...
}
{
    ...
    for each method and sample. A positive $R^2$ indicates a better fit.
}
\end{table}
