...
increasingly long training time. For example, in our tests, fitting our model to
...
%% TODO: which actual section ?
Similarly, in Figure \ref{fig:freqs}, the three data sets sequenced on the
Illumina platform display similar patterns of nonuniformity, yet differ in
magnitude, suggesting that batch effects in RNA-Seq remain a legitimate concern
