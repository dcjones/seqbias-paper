...
\title{A Model for Sequence Bias in RNA-Seq}

\begin{document}

%\maketitle

\qcjtitle{\sc{(Draft)}}{\sc{A Model for Sequencing Bias in RNA-Seq}}{Daniel C. Jones}
...
\begin{figure*}
\begin{center}
\includegraphics[width=0.75\textwidth]{fig/freqs.pdf}
\end{center}
